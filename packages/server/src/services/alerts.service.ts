...
const DEFAULT_CONFIG: AlertsConfig = {
  ...
  alerts: {
    follow: {
      enabled: true, variant: "minor", icon: "🎺", sealColor: "#D4A843",
      title: "Nouveau Follower !", subtitle: null, viewerName: "{viewer}", ribbon: null,
      parchmentDuration: 9500,
      sound: { enabled: true, file: "trumpet-fanfare.mp3", volume: 0.8 },
    ...
    sub: {
      ...
      sound: { enabled: true, file: "trumpet-fanfare.mp3", volume: 0.8 },
      media: { enabled: false, file: null, type: null },
      trumpet: { rows: { bottom: true, middle: true, top: true }, size: 250, angle: 15, pairStagger: 0.8, slideDuration: 0.7, bannerDelay: 0.3, bannerStayDuration: 6 },
    },
    resub: {
      enabled: true, variant: "minor", icon: "🛡️", sealColor: "#9b59b6",
      title: "Renouvellement de Serment !", subtitle: "{months} mois - Tier {tier}", viewerName: "{viewer}", ribbon: null,
      parchmentDuration: 9500,
      sound: { enabled: true, file: "trumpet-fanfare.mp3", volume: 0.8 },
      media: { enabled: false, file: null, type: null },
      trumpet: { rows: { bottom: true, middle: true, top: true }, size: 250, angle: 15, pairStagger: 0.8, slideDuration: 0.7, bannerDelay: 0.3, bannerStayDuration: 6 },
    ...
    dice: {
      enabled: false, variant: "minor", icon: "🎲", sealColor: "#1abc9c",
